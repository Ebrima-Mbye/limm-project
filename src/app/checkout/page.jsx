...
export default function Checkout() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 p-4 ">
      {cart.map((cartItem, index) => (
        ...
        >
          <Image
            ...
            className="w-full mx-auto max-w-[400px] mb-4 rounded-sm"
          />
          <div className="w-full flex justify-around mb-4">
            <button className="bg-orange-500 px-4 py-2">Update</button>
            <button className="bg-red-500 px-4 py-2" onClick={() => reflectDelete(cartItem.id)}>Delete</button>
          </div>
      ...
      <div className=" mt-5 border-2 border-white py-4 px-5">
