    ...
    <div className="pt-32 px-12">
      <div className="px-36">
        ...
        <p className="text-2xl">
          Get paid faster with Limm&apos;s invoicing solution. Accept various
          payment methods, send invoices with ease, and track payments in real
          time for a steady cash flow.
        </p>
