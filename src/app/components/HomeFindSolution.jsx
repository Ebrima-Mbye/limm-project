  ...
  return (
    <section className="px-14">
      ...
      <div>
        ...
        <div className="mb-12 overflow-hidden flex gap-24 flex-col lg:flex-row h-[580px] px-12 py-12 border-gray-200 border-2 rounded-[20px]">
        ...
        <div className="overflow-hidden file:mt-[100px] flex gap-24 flex-col-reverse lg:flex-row-reverse h-[580px] px-12 py-12 border-gray-200 border-2 rounded-[20px]">
          <div className="flex-1 h-full">
            <p className="text-2xl font-bold text-[#325bb7]">
              LIMM BLUETOOTH PRINTER
            </p>
            <p className="text-[19px] my-2">
              Mini Portable bluetooth receipt printer. Generate instant,
              receipts and labels for your busioness by connecting to the mobile
              app.
            </p>
            <hr className="mt-2 mb-3" />
