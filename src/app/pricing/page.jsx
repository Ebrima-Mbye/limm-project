      ...
      <div className="w-full px-24">
        <div className="flex flex-col lg:flex-row  mb-10">
          <div className="flex-1">
            <p className="font-medium text-[65px] leading-[70px]">
        ...
        <div className="mb-12 flex gap-3 justify-center items-center">
          ...
          <div className="mx-6 w-[-1px] border-gray-500 h-12 border-[1px]"></div>
        ...
        <div>
          <h3 className="mt-24 text-[45px] leading-[55.2px] font-medium">
